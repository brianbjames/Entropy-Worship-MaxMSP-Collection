...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "cartesian-polar coordinate displacement",
					"fontsize" : 10.,
					"patching_rect" : [ 106., 36., 215., 20. ],
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 0,
					"id" : "obj-35"
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "jit.gl.slab fa @file td.cartopol.jxs",
					"fontsize" : 10.,
					"patching_rect" : [ 176., 222., 173., 20. ],
					"numinlets" : 2,
					"fontname" : "Arial",
					"numoutlets" : 2,
					"id" : "obj-26",

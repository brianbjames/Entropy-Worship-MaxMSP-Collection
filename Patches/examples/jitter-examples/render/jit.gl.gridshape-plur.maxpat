...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "jit.plur @lo -1. @hi 1. @gang 0",
					"id" : "obj-26",
					"fontsize" : 10.,
					"numinlets" : 1,
					"numoutlets" : 2,
					"patching_rect" : [ 208., 266., 170., 20. ],
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "• jit.plur parameters",
					"id" : "obj-12",
					"fontsize" : 10.,
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 381., 159., 109., 20. ],
					"fontname" : "Arial"
				}

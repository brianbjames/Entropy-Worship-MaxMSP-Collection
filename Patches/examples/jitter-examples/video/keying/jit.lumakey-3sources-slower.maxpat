{
	"patcher" : 	{
		"rect" : [ 310.0, 44.0, 682.0, 575.0 ],
		"bgcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
		"bglocked" : 0,
		"defrect" : [ 310.0, 44.0, 682.0, 575.0 ],
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "3-Source LumaKey-Slower",
					"fontface" : 1,
					"id" : "obj-51",
					"numinlets" : 1,
					"fontsize" : 20.0,
					"numoutlets" : 0,
					"patching_rect" : [ 363.0, 417.0, 302.0, 33.0 ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"numoutlets" : 0,
					"patching_rect" : [ 230.0, 256.0, 70.0, 20.0 ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "slower since we're actually copying the data here...",
					"linecount" : 2,
					"id" : "obj-49",
					"numinlets" : 1,
					"fontsize" : 10.0,
					"numoutlets" : 0,
					"patching_rect" : [ 310.0, 148.0, 147.0, 33.0 ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"numoutlets" : 0,
					"patching_rect" : [ 262.0, 225.0, 54.0, 20.0 ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 146.0, 255.0, 79.0, 20.0 ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 200.0, 224.0, 59.5, 20.0 ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 299.0, 179.0, 73.0, 20.0 ],
					"fontname" : "Arial"
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 155.5, 279.0, 28.5, 279.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 349.0, 209.0, 250.0, 209.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 335.5, 212.0, 236.5, 212.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 322.0, 215.0, 223.0, 215.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 503.5, 250.0, 215.5, 250.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 28.5, 215.0, 209.5, 215.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 209.5, 245.0, 155.5, 245.0 ]
				}

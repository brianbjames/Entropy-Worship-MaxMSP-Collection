...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 357.0, 491.0, 65.0, 21.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 342.0, 383.0, 233.0, 55.0 ],
					"text" : "Experiment with adjusting the balance between the two sounds."
				}

			}
, 			{
				"box" : 				{
					"args" : [ "@file", 5, "@loop", 1, "@vol", 0 ],
					"id" : "obj-9",
					"maxclass" : "bpatcher",
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 337.0, 132.0, 225.0, 95.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 251.0, 152.0, 86.0, 55.0 ],
					"text" : "Play both example sounds."
				}

			}
, 			{
				"box" : 				{
					"args" : [ "@file", 7, "@loop", 1, "@vol", 0 ],
					"id" : "obj-23",
					"maxclass" : "bpatcher",
					"name" : "demosound.maxpat",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 11.0, 132.0, 225.0, 95.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 236.0, 152.0, 86.0, 55.0 ],
					"text" : "Play both example sounds."
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 18.0, 546.5, 136.0, 38.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 63.0, 597.0, 63.0, 40.0 ],
					"text" : "Start audio."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 18.0, 594.5, 45.0, 45.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 180.0, 180.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-2",
					"jsarguments" : [ "convolution-workshop" ],
					"maxclass" : "jsui",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 8.0, 8.0, 505.0, 60.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 429.0, 512.0, 32.5, 18.0 ],
					"text" : "127"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 429.0, 486.0, 66.0, 19.0 ],
					"text" : "Equal"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-54",
					"knobcolor" : [ 0.858824, 0.858824, 0.858824, 1.0 ],
					"maxclass" : "slider",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 330.0, 438.0, 257.0, 41.0 ],
					"size" : 256.0,
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 537.0, 154.0, 108.0, 19.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 420.0, 62.0, 65.0, 21.0 ],
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 52.0, 250.0, 50.0, 21.0 ],
									"text" : "mix out"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 190.0, 4.0, 142.0, 21.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 129.0, 4.0, 29.0, 21.0 ],
									"text" : "sf 2"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 63.0, 4.0, 43.0, 21.0 ],
									"text" : "convo"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 7.0, 4.0, 29.0, 21.0 ],
									"text" : "sf 1"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 537.0, 179.0, 97.0, 21.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 420.0, 181.0, 94.0, 21.0 ],
									"text" : "peek~ pan.aiff"
								}
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "" ],
																	"patching_rect" : [ 8.0, 161.0, 126.0, 21.0 ],
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "int" ],
																	"patching_rect" : [ 60.0, 117.0, 44.0, 21.0 ],
																	"text" : "!- 256"
																}
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "int" ],
																	"patching_rect" : [ 60.0, 77.0, 41.0, 21.0 ],
																	"text" : "- 256"
																}
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 2,
																	"outlettype" : [ "int", "int" ],
																	"patching_rect" : [ 8.0, 31.0, 71.0, 21.0 ],
																	"text" : "split 0 256"
																}
...
,
													"patching_rect" : [ 89.0, 110.0, 83.0, 21.0 ],
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 98.0, 129.0, 49.0, 21.0 ],
													"text" : "0. -> 1.",
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 99.0, 93.0, 57.0, 21.0 ],
													"text" : "0 -> 512",
													"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 44.0, 156.0, 64.0, 21.0 ],
													"text" : "pack 0 0."
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 44.0, 73.0, 34.0, 21.0 ],
													"text" : "- 1"
												}
...
, 											{
												"box" : 												{
													...
													"patching_rect" : [ 10.0, 41.0, 53.0, 21.0 ],
													"text" : "uzi 513"
												}
...
,
									"patching_rect" : [ 420.0, 154.0, 103.0, 21.0 ],
									"saved_object_attributes" : 									{
										"default_fontsize" : 10.0,
										"tags" : "",
										"description" : "",
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 420.0, 99.0, 68.0, 21.0 ],
									"text" : "bangbang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 270.0, 113.0, 41.0, 21.0 ],
									"text" : "- 128"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 29.0, 218.0, 75.0, 21.0 ],
									"text" : "selector~ 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 335.0, 113.0, 20.0, 19.0 ],
									"text" : "1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 243.5, 113.0, 20.0, 19.0 ],
									"text" : "2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 270.0, 63.0, 85.0, 21.0 ],
									"text" : "split 128 255"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 190.0, 63.0, 71.0, 21.0 ],
									"text" : "split 0 127"
								}
...
,
									"patching_rect" : [ 116.0, 153.0, 68.0, 21.0 ],
									"saved_object_attributes" : 									{
										"default_fontsize" : 10.0,
										"tags" : "",
										"description" : "",
...
,
									"patching_rect" : [ 8.0, 153.0, 68.0, 21.0 ],
									"saved_object_attributes" : 									{
										"default_fontsize" : 10.0,
										"tags" : "",
										"description" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 69.0, 63.0, 35.0, 21.0 ],
									"text" : "*~ 2"
								}
...
,
					"patching_rect" : [ 18.0, 508.0, 271.0, 21.0 ],
					"saved_object_attributes" : 					{
						"default_fontsize" : 10.0,
						"tags" : "",
						"description" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 289.0, 281.0, 116.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 12.0, 281.0, 116.0, 21.0 ],
					"text" : "delay~ 1024 1024"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 140.0, 281.0, 111.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 282.0, 448.0, 44.0, 21.0 ],
					"text" : "Noise",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 587.0, 448.0, 55.0, 21.0 ],
					"text" : "Rhythm",
					"textcolor" : [ 0.501961, 0.501961, 0.501961, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 578.5, 394.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "3",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 269.0, 128.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "2",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ],
					"textovercolor" : [ 0.2, 0.2, 0.2, 1.0 ]
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 129.75, 608.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "1",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ],
					"textovercolor" : [ 0.2, 0.2, 0.2, 1.0 ]
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 409.0, 251.0, 219.0, 81.0 ],
					"text" : "The delay~ objects compensate for the two-frame delay inherent in \"real-time\" FFT processing, bringing the dry sounds in sync with the fft-processed sounds..",
					"textcolor" : [ 0.501961, 0.501961, 0.501961, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 8.0, 76.0, 591.0, 36.0 ],
					"text" : "Source-filter convolution (see also \"cross-dog\") is a fun tool for generating interesting sounds, but it can also be used for more conventional purposes, like transforming an existing rhythm track.",
					"textcolor" : [ 0.501961, 0.501961, 0.501961, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 560.0, 8.0, 59.0, 18.0 ],
					"presentation" : 1,

...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 255.0, 327.0, 139.0, 42.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 255.0, 385.0, 44.0, 44.0 ],
...
,
					"patching_rect" : [ 720.0, 210.0, 85.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 720.0, 180.0, 80.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 720.0, 90.0, 105.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 915.0, 90.0, 81.0, 20.0 ],
					"text" : "loadmess 60"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 720.0, 120.0, 336.0, 53.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 660.0, 330.0, 232.0, 106.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 210.0, 59.0, 18.0 ],
					"text" : "rotate $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 302.0, 90.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 15.0, 557.0, 27.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 375.0, 180.0, 80.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 165.0, 120.0, 66.0, 34.0 ],
					"text" : "loadmess 0.97"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 90.0, 120.0, 66.0, 34.0 ],
					"text" : "loadmess 0.25"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 375.0, 90.0, 105.0, 20.0 ],
					"text" : "set string length"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 255.0, 60.0, 68.0, 20.0 ],
					"text" : "auto-pluck"
				}
...
,
					"patching_rect" : [ 375.0, 210.0, 85.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 570.0, 90.0, 81.0, 20.0 ],
					"text" : "loadmess 60"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 375.0, 120.0, 336.0, 53.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 405.0, 330.0, 232.0, 106.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 165.0, 210.0, 61.0, 18.0 ],
					"text" : "decay $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 90.0, 210.0, 72.0, 18.0 ],
					"text" : "dampen $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 255.0, 120.0, 66.0, 20.0 ],
					"text" : "metro 250"
				}
...
,
					"patching_rect" : [ 255.0, 267.0, 259.0, 20.0 ],
					"text" : "gen~"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 924.5, 114.5, 729.5, 114.5 ],
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 579.5, 114.5, 384.5, 114.5 ],
					"source" : [ "obj-35", 0 ]
				}

{
	"patcher" : 	{
		"rect" : [ 423.0, 44.0, 347.0, 427.0 ],
		"bgcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
		"bglocked" : 0,
		"defrect" : [ 423.0, 44.0, 347.0, 427.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "embosser",
					"numinlets" : 1,
					"patching_rect" : [ 196.0, 69.0, 60.0, 20.0 ],
					"fontsize" : 10.0,
					"numoutlets" : 0,
					"fontname" : "Arial",
					"id" : "obj-15"
...
, 			{
				"box" : 				{
					...
					"text" : "jit.qtfx.embs",
					"numinlets" : 1,
					"patching_rect" : [ 196.0, 41.0, 146.0, 33.0 ],
					"fontsize" : 20.0,
					"numoutlets" : 0,
					"fontname" : "Arial",
					"fontface" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "• emboss amount (0-6)",
					"numinlets" : 1,
					"patching_rect" : [ 104.0, 115.0, 132.0, 20.0 ],
					"fontsize" : 10.0,
					"numoutlets" : 0,
					"fontname" : "Arial",
					"id" : "obj-13"
...
, 			{
				"box" : 				{
					...
					"text" : "emboss $1",
					"numinlets" : 2,
					"patching_rect" : [ 140.0, 94.0, 67.0, 18.0 ],
					"fontsize" : 10.0,
					"numoutlets" : 1,
					"fontname" : "Arial",
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					...
					"text" : "jit.qtfx.embs",
					"numinlets" : 1,
					"patching_rect" : [ 14.0, 115.0, 72.0, 20.0 ],
					"fontsize" : 10.0,
					"numoutlets" : 1,
					"fontname" : "Arial",

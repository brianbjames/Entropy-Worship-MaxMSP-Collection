...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "2-pass median blur",
					"fontsize" : 10.,
					"patching_rect" : [ 110., 41., 119., 20. ],
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 0,
					"id" : "obj-35"
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "cf.median.2p.jxs",
					"fontsize" : 20.,
					"patching_rect" : [ 110., 9., 209., 33. ],
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 0,
					"fontface" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "jit.gl.slab fa @file cf.median.2p.jxs",
					"fontsize" : 10.,
					"patching_rect" : [ 176., 222., 185., 20. ],
					"numinlets" : 2,
					"fontname" : "Arial",
					"numoutlets" : 2,
					"id" : "obj-26",

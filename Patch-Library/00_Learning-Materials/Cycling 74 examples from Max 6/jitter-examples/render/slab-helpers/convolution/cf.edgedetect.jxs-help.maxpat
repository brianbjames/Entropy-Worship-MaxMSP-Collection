...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "edge-detection filter",
					"fontsize" : 10.,
					"patching_rect" : [ 113., 33., 118., 20. ],
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 0,
					"id" : "obj-35"
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "cf.edgedetect.jxs",
					"fontsize" : 20.,
					"patching_rect" : [ 113., 3., 197., 33. ],
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 0,
					"fontface" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "jit.gl.slab fa @file cf.edgedetect.jxs",
					"fontsize" : 10.,
					"patching_rect" : [ 176., 222., 189., 20. ],
					"numinlets" : 2,
					"fontname" : "Arial",
					"numoutlets" : 2,
					"id" : "obj-26",

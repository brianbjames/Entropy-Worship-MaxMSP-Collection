...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "2D-reflection distortion",
					"fontname" : "Arial",
					"numoutlets" : 0,
					"fontsize" : 10.,
					"id" : "obj-35",
					"patching_rect" : [ 115., 36., 127., 20. ],
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "jit.gl.slab fa @file td.mirror.jxs",
					"fontname" : "Arial",
					"numoutlets" : 2,
					"fontsize" : 10.,
					"id" : "obj-26",
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 176., 222., 162., 20. ],
					"numinlets" : 2
				}
